...
authRouter.post("/register", requestDtoValidationMiddleware(RegistrationPayloadDto, {isBody: true}), AuthController.register);
authRouter.post("/login", requestDtoValidationMiddleware(LoginPayloadDto, {isBody: true}), AuthController.login);
