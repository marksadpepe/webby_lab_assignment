import {IsArray, IsEnum, IsNumber, IsString, IsUUID, ValidateNested} from "class-validator";
import { CreateMovieData, CreateMoviePayload, MovieFormat } from "../interfaces/movie";
...
class CreateMovieDataDto implements CreateMovieData {
  ...
  @IsEnum(MovieFormat, {message: `format must be one of: ${Object.values(MovieFormat)}`})
  format: MovieFormat
